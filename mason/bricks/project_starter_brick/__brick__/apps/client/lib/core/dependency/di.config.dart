...
import 'package:{{name.snakeCase()}}_core/{{name.snakeCase()}}_core.dart' as _i548;
import 'package:{{name.snakeCase()}}_core/{{name.snakeCase()}}_core.module.dart' as _i1002;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  Future<_i174.GetIt> init({
    ...
    await _i1002.{{name.pascalCase()}}CorePackageModule().init(gh);
    ...
    gh.lazySingleton<_i548.TokenStorage>(() => _i535.SecureTokenStorage());
    gh.singleton<_i954.AppFlavor>(
      () => _i954.ProdFlavor(),
      registerFor: {_prod},
    );
