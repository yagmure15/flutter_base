import 'package:{{name.snakeCase()}}/config/app_flavor.dart';
import 'package:{{name.snakeCase()}}/core/dependency/di.dart';
import 'package:{{name.snakeCase()}}/core/router/app_router.dart';
import 'package:{{name.snakeCase()}}/core/storage/secure_token_storage.dart';
import 'package:{{name.snakeCase()}}/core/translations/strings.g.dart';
...
/// `{{name.snakeCase()}}_core` micro package.
void main() {
