...
The core infrastructure package for the Flutter Base ecosystem. This package provides the essential building blocks for creating robust, scalable Flutter applications using **Feature-First Clean Architecture**.
...
This package is part of the [Flutter Base](https://github.com/yagmure15/flutter_base) monorepo. Please modify the code in `packages/core`.
